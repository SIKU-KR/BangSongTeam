...
export function StageLyricsEditor({
  ...
  return (
    <textarea
      ...
      onBlur={onExit}
      spellCheck={false}
      className="m-0 block w-full min-w-[4ch] resize-none overflow-hidden border-0 bg-transparent p-0 outline-none select-text placeholder:text-current placeholder:opacity-40"
      style={
        {
          font: "inherit",
          color: "inherit",
