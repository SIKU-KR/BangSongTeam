...
import { decks, lyricsCatalog, reports, user } from "../schema";
...
describe("createReport", () => {
  ...
  it("accepts catalog reports and manual correction suggestions", async () => {
    expect(
      (
  ...
  it("does not accept reports on private or unknown targets", async () => {
    for (const input of [
      ...
      {
        targetType: "catalog" as const,
        targetId: "d0000000-0000-4000-8000-00000000dead",
      },
    ]) {
      expect(
