...
- [x] **Task 2.2: 스타일 및 텍스트 박스 위치 Zod 스키마 정의**
  - **대상 파일**: `src/shared/schemas/style.ts`
  - **선행 조건**: Task 2.1
  - **구현 내용**:
...
- [x] **Task 2.3: 슬라이드 스키마 정의 및 단위 테스트 작성**
  - **대상 파일**: `src/shared/schemas/slide.ts`, `src/shared/schemas/slide.test.ts`
  - **선행 조건**: Task 2.2
  - **구현 내용**:
...
- [x] **Task 2.4: 덱(Deck) 도메인 스키마 정의 (Clone-on-Add 스코프 반영)**
  - **대상 파일**: `src/shared/schemas/deck.ts`
  - **선행 조건**: Task 2.3
  - **구현 내용**:
...
- [x] **Task 2.5: 프레젠테이션(Presentation) 도메인 스키마 정의**
  - **대상 파일**: `src/shared/schemas/presentation.ts`
  - **선행 조건**: Task 2.4
  - **구현 내용**:
...
- [x] **Task 2.6: 배경 미디어 및 가사 카탈로그 스키마 정의**
  - **대상 파일**: `src/shared/schemas/media.ts`, `src/shared/schemas/catalog.ts`
  - **선행 조건**: Task 2.1
  - **구현 내용**:
...
- [x] **Task 2.7: BroadcastChannel 동기화 메시지 스키마 및 단위 테스트 작성**
  ...
  - **대상 파일**: `src/shared/schemas/broadcast.ts`, `src/shared/schemas/broadcast.test.ts`
  - **선행 조건**: Task 2.1
  - **구현 내용**:
...
- [x] **Task 2.9: 가사 정제 및 슬라이드 분할 규칙 단위 테스트 작성 (TDD Red)**
  - **대상 파일**: `src/shared/utils/lyrics.test.ts`
  - **선행 조건**: Task 2.3
  - **구현 내용**:
...
- [x] **Task 2.10: 가사 정제 및 슬라이드 분할 유틸리티 구현 (TDD Green)**
  - **대상 파일**: `src/shared/utils/lyrics.ts`
  - **선행 조건**: Task 2.9
  - **구현 내용**:
...
- [x] **Task 2.11: 공유 상수 선언 및 메인 배럴 엔트리포인트 완성**
  - **대상 파일**: `src/shared/constants/index.ts`, `src/shared/index.ts`
  - **선행 조건**: Task 2.2 ~ Task 2.10
  - **구현 내용**:
    - 상수: 폰트 목록, 3x3 앵커 좌표, 텍스트 그림자 CSS 프리셋 정의
    - `src/shared/index.ts`에서 모든 스키마, 타입, 유틸리티 함수 export
